...
// The main() function here gives the user a choice on whether they want to PUSH, POP, or DISPLAY the stack. The proper fucntion is called here using switch. Similarly, if the user enters an invalid choice, then it is made known to the user. There is also an option to EXIT the progam. 
