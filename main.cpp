...
// This functions in a similar manner as if you were to make a stack of plates.
// In this scenario, adding or removing is only possible at the top.
...
// The proper fucntion is called here using switch.
// Similarly, if the user enters an invalid choice, then it is made known to the user.
